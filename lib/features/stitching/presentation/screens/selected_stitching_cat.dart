...
class SelectedStitchingCat extends StatelessWidget {
            ...
            ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                Expanded(child: Column(
                  ...
                  children: [
                    Text("${selectedCat[index].label} Stitching",
                    style: TextStyle(
                      fontWeight: FontWeight.w600,
                      color: black2,
                      fontSize: 16.sp
                    ...
                    SizedBox(height: 1.h,),
                    Text("${selectedCat[index].length} Garments",
                    style: TextStyle(
                ...
                const Icon(Icons.keyboard_arrow_down_outlined, color: black2,)
                    ],
                  ), 
                  ...
                  expanded: ListView.separated(
                    ...
                    itemBuilder: (context, indx) {
                      return InkWell(
                        onTap: () {
                          Navigator.pushNamed(context, "/upload-stitching-data",
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 5.w,),
                              Text("${selectedCat[index].label} ${indx + 1}",
                              style: TextStyle(
                                fontWeight: FontWeight.w500,
                                fontSize: 16.sp,
                                color: black2
